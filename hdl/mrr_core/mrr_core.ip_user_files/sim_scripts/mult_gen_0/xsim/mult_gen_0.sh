...
#
# Script generated by Vivado on Sun Aug 25 01:28:19 -0400 2024
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_13 -L xbip_pipe_v3_0_9 -L xbip_bram18k_v3_0_9 -L mult_gen_v12_0_21 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mult_gen_0 xil_defaultlib.mult_gen_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mult_gen_0 -key {Behavioral:sim_1:Functional:mult_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/mrr_ddc.protoinst" -log simulate.log
}
