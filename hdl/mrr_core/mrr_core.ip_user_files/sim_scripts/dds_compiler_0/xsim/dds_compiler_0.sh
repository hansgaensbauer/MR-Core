...
#
# Script generated by Vivado on Sun Aug 25 01:28:21 -0400 2024
...
simulate()
{
  xsim dds_compiler_0 -key {Behavioral:sim_1:Functional:dds_compiler_0} -tclbatch cmd.tcl -protoinst "protoinst_files/mrr_ddc.protoinst" -log simulate.log
}
