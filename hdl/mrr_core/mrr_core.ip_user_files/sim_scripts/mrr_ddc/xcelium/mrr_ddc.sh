...
#
# Script generated by Vivado on Sun Aug 25 14:17:32 -0400 2024
...
#
# Usage        : mrr_ddc.sh
#                mrr_ddc.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mrr_ddc.sh [-reset_run]
#                mrr_ddc.sh [-reset_log]
#                mrr_ddc.sh [-help]
#
...
#                script (type 'mrr_ddc.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_13 -libname axi_utils_v2_0_9 -libname xbip_pipe_v3_0_9 -libname xbip_bram18k_v3_0_9 -libname mult_gen_v12_0_21 -libname cmpy_v6_0_24 -libname xil_defaultlib -libname xbip_dsp48_wrapper_v3_0_6 -libname xbip_dsp48_addsub_v3_0_9 -libname xbip_dsp48_multadd_v3_0_9 -libname dds_compiler_v6_0_25 -libname xlslice_v1_0_4 -libname cic_compiler_v4_0_19 -libname fir_compiler_v7_2_22 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_utils_v3_0_13 axi_utils_v2_0_9 xbip_pipe_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 cmpy_v6_0_24 xil_defaultlib xbip_dsp48_wrapper_v3_0_6 xbip_dsp48_addsub_v3_0_9 xbip_dsp48_multadd_v3_0_9 dds_compiler_v6_0_25 xlslice_v1_0_4 cic_compiler_v4_0_19 fir_compiler_v7_2_22)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "mrr_ddc.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mrr_ddc.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mrr_ddc xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mrr_ddc -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mrr_ddc_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mrr_ddc.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mrr_ddc.sh [-help]\n\
Usage: mrr_ddc.sh [-step]\n\
Usage: mrr_ddc.sh [-lib_map_path]\n\
Usage: mrr_ddc.sh [-reset_run]\n\
Usage: mrr_ddc.sh [-reset_log]\n\
Usage: mrr_ddc.sh [-keep_index]\n\
Usage: mrr_ddc.sh [-noclean_files]\n\n\
