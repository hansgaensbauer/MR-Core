...
design_libs=(xpm xbip_utils_v3_0_13 axi_utils_v2_0_9 xbip_pipe_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 cmpy_v6_0_24 xil_defaultlib xbip_dsp48_wrapper_v3_0_6 xbip_dsp48_addsub_v3_0_9 xbip_dsp48_multadd_v3_0_9 dds_compiler_v6_0_25 xlslice_v1_0_4 cic_compiler_v4_0_19 fir_compiler_v7_2_22)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mrr_ddc xil_defaultlib.glbl -o mrr_ddc_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mrr_ddc_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key mrr_ddc_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mrr_ddc_simv.daidir vcs_lib c.obj)
