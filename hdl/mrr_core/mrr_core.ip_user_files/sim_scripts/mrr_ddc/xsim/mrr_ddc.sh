...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_13 -L axi_utils_v2_0_9 -L xbip_pipe_v3_0_9 -L xbip_bram18k_v3_0_9 -L mult_gen_v12_0_21 -L cmpy_v6_0_24 -L xil_defaultlib -L xbip_dsp48_wrapper_v3_0_6 -L xbip_dsp48_addsub_v3_0_9 -L xbip_dsp48_multadd_v3_0_9 -L dds_compiler_v6_0_25 -L xlslice_v1_0_4 -L cic_compiler_v4_0_19 -L fir_compiler_v7_2_22 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mrr_ddc xil_defaultlib.mrr_ddc xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mrr_ddc -key {Behavioral:sim_1:Functional:mrr_ddc} -tclbatch cmd.tcl -protoinst "protoinst_files/mrr_ddc.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mrr_ddc.wdb xsim.dir libdpi.so)
