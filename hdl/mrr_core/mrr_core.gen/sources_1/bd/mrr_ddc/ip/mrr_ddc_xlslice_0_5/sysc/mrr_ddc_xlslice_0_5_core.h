...
#ifndef _mrr_ddc_xlslice_0_5_core_h_
#define _mrr_ddc_xlslice_0_5_core_h_

#include <systemc.h>
#include "properties.h"


class mrr_ddc_xlslice_0_5_core : public sc_module 
{
    public: 
       mrr_ddc_xlslice_0_5_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , Din    ( "Din" )
              , Dout   ( "Dout" )
    {
        SC_HAS_PROCESS(mrr_ddc_xlslice_0_5_core);
        SC_METHOD(get_slice_value);
        sensitive << Din;

    }

    virtual ~mrr_ddc_xlslice_0_5_core() = default;
